...
4) Configure as variáveis SUPABASE_URL e SUPABASE_KEY logo abaixo de CSV_DIR neste arquivo.
5) Execute:
...
# Cole aqui os dados do Supabase da GarageHub
...
def main() -> None:
    if "COLE_AQUI" in SUPABASE_URL or "COLE_AQUI" in SUPABASE_KEY:
        raise ValueError("Configure SUPABASE_URL e SUPABASE_KEY no início do arquivo antes de executar.")
